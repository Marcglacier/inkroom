...
def register_messaging_events(socketio):
    ...
    #
    # LIVE READ RECEIPT + LAST READ POSITION
    #
    ...
    def mark_read(data):
        ...
        #
        # 🔥 CHECK USER IS ACTUALLY IN CHAT
        #

        current_chat = active_chambers.get(
            user_id
        )
        ...
        if current_chat != conversation_id:
            ...
            print(
                "🚫 USER NOT INSIDE CHAT - IGNORING READ"
            )
        ...
        print(
            "🔥 READ RECEIPT + LAST READ COMPLETE"
        )