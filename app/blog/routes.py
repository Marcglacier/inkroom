...
from app.blog.views.toggle_post_like import TogglePostLikeAPI
from app.blog.views.toggle_repost import ToggleRepostAPI
...
blog_bp.add_url_rule("/<int:post_id>/like", view_func=TogglePostLikeAPI.as_view("toggle_post_like"), methods=["POST"])
blog_bp.add_url_rule("/<int:post_id>/repost", view_func=ToggleRepostAPI.as_view("toggle_repost"), methods=["POST"])
