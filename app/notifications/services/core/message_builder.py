# app/notifications/services/core/message_builder.py
...
def build_notification_message(group):
    ...
    if count == 0:
        ...
        name_part = f"{actors[0]['username']} and {actors[1]['username']}"
    ...
    action = message_map.get(notif_type, "interacted with you")
